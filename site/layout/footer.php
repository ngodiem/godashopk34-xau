                ...
                <div class="col-xs-12">
                    <div class="container">
                     ...
                     <?php 
                      ...
                      $footerCats = $categoryRepository->getAll();
                     ?>
        ...
        <div class="modal fade" id="modal-register" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="register" action="index.php?c=customer&a=register" method="POST" role="form">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-color">
                        ...
                        // echo $loginUrl;
                         // tạo ra đường link để xác nhận google xác nhận sau khi xác nhận xong 
                         // gọi đến hàm loginGoogle()
                        ?>
                        ...
                        <div class="text-center">
                            ...
                            $fb = new Facebook\Facebook([
                                ...
                                // tạo ra đường link để xác nhận facebook xác nhận sau khi xác nhận xong 
                                // gọi đến hàm loginFacebook()
                            ?>
