...
<!-- copy main html -->
<!-- cắt bỏ aside rq file sidebar vào -->
<!--  -->
            ...
            <div class="col-md-9 product-detail">
                <div class="row product-info">
                    <div class="col-md-6">
                        ...
                        <div class="product-detail-carousel-slider">
                            <div class="owl-carousel owl-theme">
                                ...
                                <!-- $imageItem hình chụp từ nhiều khía cạnh khác nhau -->
                    ...
                    <div class="col-md-6">
                        ...
                        <span>Giá: </span>
                        <!-- getSalePrice() giá đã giảm, getPrice() giá chưa giảm -->
                            <?php if($product->getSalePrice() != $product->getPrice()): ?> 
                            <span class="product-item-regular">
                                <?=number_format($product->getPrice())?>₫</span>
                            <?php endif ?>
                            <span class="product-item-discount">
                                <?=number_format($product->getSalePrice())?>₫</span>
                        </div>
                        <?php if( $product->getInventoryQty() > 0): ?>
