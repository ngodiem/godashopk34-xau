        ...
        <div class="row">
            ...
            <div class="col-md-9 account">
                <div class="row">
                    ...
                    <div class="clearfix"></div>
                    <div class="col-md-6">
                        <form class="info-account" action="index.php?c=account&a=updateProfile" method="POST" role="form">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="old-password" placeholder="Mật khẩu hiện tại">
                            </div>
                            <div class="form-group">
